...
public class InputDataMahasiswa extends JFrame {
    ...
    String DBurl = "jdbc:mysql://localhost/praktikumjava";
    ...
    public InputDataMahasiswa() {
        ...
        panelForm = new JPanel(new GridLayout(4,4,4,4));
    ...
    public void masukkanData() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Data gagal Disimpan, "+ex.getLocalizedMessage(), "Hasil", JOptionPane.ERROR_MESSAGE);
